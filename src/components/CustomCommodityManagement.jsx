...
import { Plus, Store, MapPin, Calendar, TrendingUp, TrendingDown, Edit2, Trash2, Filter, RefreshCw, Download, Upload, Search, Package } from 'lucide-react';
...
import CustomCommodityManagement from '../components/CustomCommodityManagement';
...
const ManualPriceInputPage = () => {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      />
      <CustomCommodityManagement
        isOpen={showCommodityModal}
        onClose={() => setShowCommodityModal(false)}
        onCommodityCreated={() => {
          // Refresh data when new commodity is created
          fetchMarketPrices();
          fetchStats();
        }}
      />
