            ...
            <div className="bg-white/80 backdrop-blur-sm rounded-3xl p-12 shadow-2xl border border-white/20">
              <div className="text-center mb-8">
                ...
                <p className="text-xl text-gray-600 leading-relaxed">
                  Platform monitoring harga pangan nasional yang terpercaya
                </p>
              </div>
              ...
              <div className="space-y-6">
                <div className="flex items-center p-4 bg-gradient-to-r from-emerald-50 to-green-50 rounded-2xl border border-emerald-200">
                  ...
                  <div>
                    <h3 className="font-bold text-emerald-800">Data Terverifikasi</h3>
                    <p className="text-emerald-600 text-sm">Informasi resmi dari BPN dan pasar lokal</p>
                  </div>
                </div>
                ...
                <div className="flex items-center p-4 bg-gradient-to-r from-blue-50 to-indigo-50 rounded-2xl border border-blue-200">
                  ...
                  <div>
                    <h3 className="font-bold text-blue-800">Real-time Updates</h3>
                    <p className="text-blue-600 text-sm">Monitoring 24/7 untuk data terkini</p>
                  </div>
                </div>
                ...
                <div className="flex items-center p-4 bg-gradient-to-r from-purple-50 to-indigo-50 rounded-2xl border border-purple-200">
                  ...
                  <div>
                    <h3 className="font-bold text-purple-800">Akses Lengkap</h3>
                    <p className="text-purple-600 text-sm">Dashboard admin untuk manajemen data</p>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="w-full max-w-md mx-auto">
            <div className="bg-white/90 backdrop-blur-lg rounded-3xl shadow-2xl border border-white/20 p-8 lg:p-10">
              ...
              <div className="text-center mb-8">
                ...
                <p className="text-gray-600">Masuk ke dashboard admin Pantau Pangan</p>
              </div>
              ...
              {error && (
                <div className="mb-6 p-4 bg-red-50 border border-red-200 rounded-2xl flex items-start">
                  ...
                  <div>
                    <h4 className="font-semibold text-red-800">Login Failed</h4>
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      onChange={handleChange}
                      className="w-full pl-12 pr-12 py-4 text-gray-800 bg-white border-2 border-gray-200 rounded-2xl focus:outline-none focus:border-blue-500 focus:ring-4 focus:ring-blue-200 transition-all duration-300"
